...
/*--------------------- Start Chat Boat ---------------------- */
   ...
   var kid = {
    ...
    copypastas: [
        ...
        "(â—•â€¿â—•âœ¿) Kawaii in the saree. Purchase with huge Discount ( ÍÂ° ÍœÊ–Í¡Â°)",
        ...
        "ðŸ’¯ðŸ’¯At the End ðŸ˜‚ðŸ˜‚ðŸ˜‚ Sir ðŸ‘Œi AM ðŸ‘‰LITERALLYðŸ‘ˆ iN ðŸ˜‚TEARSðŸ˜‚ RIGHT NOW ðŸ‘†ðŸ‘‡ðŸ‘‰ðŸ‘ˆ hHAHAHAHAHAHAHA âœŒï¸ðŸ‘ŒðŸ‘ TAHT You are FUNNY DUd ðŸ’§ðŸ’§ðŸ˜…ðŸ˜‚ðŸ’¦ðŸ’§I cAN NOT Help you how ðŸ’¯FUNny ðŸ‘ŒðŸ‘ðŸ’¯thta shit wa s ðŸ‘€ðŸ‘ðŸ˜†ðŸ˜‚ðŸ˜‚ðŸ˜… I ðŸ‘¦ CAN NOT âŒ bRATHE ðŸ‘ƒðŸ‘„ðŸ‘ƒðŸ‘„âŒâŒ / HELP â—ï¸I NEEd ðŸ‘‰ðŸ‘‰ AN a m b u l a n c eðŸš‘ðŸš‘ SSSooOOoo00000oOOOOOÃ¸Ã¸Ã¸Ã˜Ã˜Ã˜Ã˜Ã˜ f**kING FUNY âœ”ï¸â˜‘ï¸ðŸ’¯ðŸ’¯1ï¸âƒ£0ï¸âƒ£0ï¸âƒ£ðŸ˜†ðŸ˜†ðŸ˜‚ðŸ˜‚ðŸ˜… shit man â•ðŸ’¯ðŸ’¯ðŸ”¥â˜ï¸ðŸ‘Œdamn",
    ],
    afkAlmostGone: [
        "...?",
        "lol scared sir?",
