...
$(document).ready(function() {
        ...
        datasets: [
          {
            ...
            backgroundColor: ["#008000", "#FF0000", "#FFA500", "#808080", "#800080", "#FF4500"],
            borderWidth: 1
          }
        ]
      },
  ...
  if (acquisition !== null) {
    var acqData = [
      {
        first: [120, 180, 34, 76, 155, 56, 90],
        second: [174, 54, 177, 86, 25, 199, 15],
        third: [46, 168, 106, 124, 187, 81, 137]
      },
      {
        first: [146, 49, 111, 8, 125, 81, 17],
        second: [28, 128, 42, 130, 119, 51, 186],
        third: [51, 47, 149, 79, 158, 161, 72]
      },
      {
        first: [133, 86, 122, 61, 178, 37, 29],
        second: [40, 147, 77, 72, 126, 81, 116],
        third: [151, 27, 162, 85, 119, 55, 187]
      }
    ];
    ...
    var configAcq = {
      ...
      data: {
        ...
        datasets: [
          ...
          {
            label: "Direct",
            backgroundColor: "rgb(246,210,88)",
            borderColor: "rgba(237,245,148, .7)",
            data: acqData[0].second,
            lineTension: 0.3,
            pointBackgroundColor: "rgba(52, 116, 212, 0)",
            pointHoverBackgroundColor: "rgb(246,210,88)",
            pointHoverRadius: 3,
            pointHitRadius: 30,
            pointBorderWidth: 2,
            pointStyle: "rectRounded"
          ...
          {
            label: "Organic",
            backgroundColor: "rgb(9,67,239,1)",
            borderColor: "rgba(126,156,236,.7)",
            data: acqData[0].third,
            lineTension: 0.3,
            pointBackgroundColor: "rgba(178, 251, 212, 0)",
            pointHoverBackgroundColor: "rgba(9,67,239, 1)",
            pointHoverRadius: 3,
            pointHitRadius: 30,
            pointBorderWidth: 2,
            pointStyle: "rectRounded"
        ...
        datasets: [
          {
            label: "Active",
            backgroundColor: "transparent",
            borderColor: "rgba(13,62,166,0.8)",
...
if (acquisition3 !== null) {
  var acChart3 = new Chart(acquisition3, {
    ...
    // The data for our dataset
    data: {
      labels: ["4 April", "5 April", "6 April", "7 April", "8 April", "9 April", "10 April"],
      datasets: [
        {
          label: "Referral",
